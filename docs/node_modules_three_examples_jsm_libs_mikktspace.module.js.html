...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/three/examples/jsm/libs/mikktspace.module.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/three/examples/jsm/libs/mikktspace.module.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>const lTextDecoder = typeof TextDecoder === 'undefined' ? (0, module.require)('util').TextDecoder : TextDecoder;
