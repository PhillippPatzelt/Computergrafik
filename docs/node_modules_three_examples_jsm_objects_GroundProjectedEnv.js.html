...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/three/examples/jsm/objects/GroundProjectedEnv.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/three/examples/jsm/objects/GroundProjectedEnv.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import { Mesh, IcosahedronGeometry, ShaderMaterial, DoubleSide } from 'three';
